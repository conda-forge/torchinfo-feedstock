...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/torchinfo-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13758&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/torchinfo-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `torchinfo` can be installed with:

```
conda install torchinfo
```

It is possible to list all of the versions of `torchinfo` available on your platform with:
